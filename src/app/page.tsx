          ...
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
             <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
                ...
                <div className='absolute inset-x-0 bottom-0 bg-gradient-to-t via-slate-50/50 from-slate-50 h-28' />
                     <Image width={100} height={100} src="/snake-1.png" className="w-full" alt="hero Image"/> 
                </div>
                ...
                <div className="mt-12 flex flex-col sm:flex-row items-center sm:items-start gap-5">
                  <div className="flex -space-x-4">
                    <Image width={100} height={100} className="inline-block h-10 w-10 rounded-full ring-2 ring-slate-100" src="/users/user-1.png" alt="user image"/>

                    <Image width={100} height={100} className="inline-block h-10 w-10 rounded-full ring-2 ring-slate-100" src="/users/user-2.png" alt="user image"/>

                    <Image width={100} height={100} className="inline-block h-10 w-10 rounded-full ring-2 ring-slate-100" src="/users/user-3.png" alt="user image"/>

                    <Image width={100} height={100} className="inline-block h-10 w-10 rounded-full ring-2 ring-slate-100" src="/users/user-4.jpg" alt="user image"/>

                    <Image width={100} height={100} className="inline-block object-cover h-10 w-10 rounded-full ring-2 ring-slate-100" src="/users/user-5.jpg" alt="user image"/>
                  </div>

                  <div className="flex flex-col justify-between items-center sm:items-start">
                    <div className="flex gap-0.5">
                      <Star className="h-4 w-4 text-red-700 filll-red-700"/>
                      <Star className="h-4 w-4 text-red-700 filll-red-700"/>
                      <Star className="h-4 w-4 text-red-700 filll-red-700"/>
                      <Star className="h-4 w-4 text-red-700 filll-red-700"/>
                      <Star className="h-4 w-4 text-red-700 filll-red-700"/>
          ...
          <div className="max-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0  lg:max-w-none lg:grid-cols-2 gap-y-16">
             <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
               <div className="flex gap-0.5 mb-2">
                  <Star className="h-5 w-5 text-red-700 fill-red-700" />
                  <Star className="h-5 w-5 text-red-700 fill-red-700" />
                  <Star className="h-5 w-5 text-red-700 fill-red-700" />
                  <Star className="h-5 w-5 text-red-700 fill-red-700" />
                  <Star className="h-5 w-5 text-red-700 fill-red-700" />
               ...
               <div className="flex gap-4 mt-2">
                <Image width={100} height={100} src='/users/user-1.png' className="rounded-full h-12 w-12 object-cover" alt="user" />
                <div className="flex flex-col">
                  <p className="font-semibold">
                    Jonathan
                  </p>
                <div className="flex gap-1.5 items-center text-zinc-600">
                    <BadgeCheck className="h-4 w-4 strole-[3px] text-red-700" />
             ...
             <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
               ...
               <div className="flex gap-4 mt-2">
                <Image width={100} height={100} src='/users/user-4.jpg' className="rounded-full h-12 w-12 object-cover" alt="user" />
                <div className="flex flex-col">
                  <p className="font-semibold">
                    Harry
                  </p>
      ...
      <section>
        <MaxWidthWrapper className="py-24">
          <div className="mb-12 px-6 lg:px-8">
             ...
             <h2 className="order-1 mt-2 tracking-tight text-balance !leading-tight font-bold text-5xl md:text-6xl">
                   Upload your photo and get <span className="relative px-2 bg-red-700 text-white">your own case </span>  Now
              </h2>
             </div>
          </div>
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
              <div className="relative flex flex-col items-center md:grid grid-cols-2 gap-40">
                <Image src="/arrow.png" className="absolute top-[25rem] md:top-1/2 -translate-y-1/2 z-10 left-1/2 -translate-x-1/2 rotate-90 md:rotate-0" alt="Arrow" width={100} height={100}/>

                <div className="relative h-80 md:h-full w-full md:justify-self-end max-w-sm rounded-xl bg-gray-900/5 ring-inset ring-gray-900/10 lg:rounded-2xl">
                  <Image alt="Demo image" width={100} height={100} src="/horse.jpg"  className="rounded-md object-cover bg-white shadow-2xl ring-1 ring-gray-900/10 h-full w-full"/>
                </div>
         ...
         <ul className="mx-auto mt-12 max-w-prose sm:text-lg space-y-2 w-fit">
          <li className="w-fit">
           <Check className="h-5 w-5 text-red-700 inline mr-1.5"/>
