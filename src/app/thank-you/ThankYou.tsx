    ...
    if (data === false) {
      return (
        <div className="w-full mt-24 flext justify-center">
          <div className="flex flex-col items-center gap-2">
            <Loader className='h-8 w-8 animate-spin text-zinc-500' />
            <h3 className="font-semibold text-xl">Varifing your payment...</h3>
        ...
        <div className="max-w-xl">
          ...
          <div className="mt-10 border-t border-zinc-200">
            <div className="mt-10 flex flex-col flex-auto">
              ...
              We at MomentsCovers believe that a phone case doesn&#39;t only need to
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-x-6 border-t border-zinc-200 py-10 text-sm">
              ...
              <div>
                ...
                <p className="mt-2 text-zinc-700">DHL, taks up to 3 working days</p>
              </div>
            </div>
          </div>
