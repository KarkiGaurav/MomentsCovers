...
const OrderReceivedEmail = ({ 
    ...
    const baseUrl = process.env.NODE_ENV === 'development' ? 'http://localhost:3000' : 'https://moments-covers.vercel.app'
  return (
    <Html>
      <Head />
      <Preview>Your order summary and astimate delivery date</Preview>
      <Body style={main}>
        <Container style={container}>
          <Section style={message} >
            <Img 
            src={`${baseUrl}/images/public/panda.png`}
            width='75'
            height='75'
            alt='Logo'
            style={{margin: 'auto'}}
          ...
          <Section style={paddingY}>
             ...
             <Row>
               ...
               © MomentsCovers, Inc. All Rights Reserved.
               </Text>
             </Row>
          </Section>
